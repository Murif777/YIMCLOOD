...
CREATE TABLE `facturas_productos` (
  ...
  KEY `Referencia_Producto` (`Referencia_Producto`),
  CONSTRAINT `facturas_productos_ibfk_1` FOREIGN KEY (`Id_Factura`) REFERENCES `facturas` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `facturas_productos_ibfk_2` FOREIGN KEY (`Referencia_Producto`) REFERENCES `productos` (`Referencia`) ON DELETE CASCADE
