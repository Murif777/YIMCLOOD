...
CREATE TABLE `rutinas_ejercicios` (
  ...
  `Ejercicio_Nombre` varchar(50) NOT NULL,
  PRIMARY KEY (`Id_Rutina`,`Ejercicio_Nombre`),
  KEY `Ejercicio_Nombre` (`Ejercicio_Nombre`),
  CONSTRAINT `rutinas_ejercicios_ibfk_1` FOREIGN KEY (`Id_Rutina`) REFERENCES `rutinas` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `rutinas_ejercicios_ibfk_2` FOREIGN KEY (`Ejercicio_Nombre`) REFERENCES `ejercicios` (`Nombre`)
